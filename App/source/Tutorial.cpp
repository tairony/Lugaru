...
void Tutorial::DrawTextInfo()
{
	...
	default:
		break;
	case 1:
		string1 = "Welcome to the Lugaru training level!";
		break;
	case 2:
		string1 = "BASIC MOVEMENT:";
		break;
	case 3:
	...
	case 8:
		...
		break;
	case 9:
		string1 = "Release the crouch key while sneaking and hold the movement keys";
	...
	case 11:
		...
		break;
	case 12:
		string1 = "While in the air, you can press crouch to flip.";
		string2 = "Walljumps and flips confuse enemies and give you more control.";
		break;
	case 13:
		string1 = "BASIC COMBAT:";
		break;
	case 14:
		string1 = "There is now an imaginary enemy";
	...
	case 15:
		...
		break;
	case 16:
		string1 = "If you are close, you will perform a weak punch.";
		string2 = "The weak punch is excellent for starting attack combinations.";
		break;
	case 17:
		string1 = "Attacking while running results in a spin kick.";
		string2 = "This is one of your most powerful ground attacks.";
		break;
	case 18:
		string1 = "Sweep the enemy's legs out by attacking while crouched.";
		string2 = "This is a very fast attack, and easy to follow up.";
		break;
	case 19:
		string1 = "When an enemy is on the ground, you can deal some extra";
	...
	case 21:
		...
		break;
	case 22:
		string1 = "If you sneak behind an enemy unnoticed, you can kill";
		string2 = "him instantly. Move close behind this enemy";
		string3 = "and attack.";
		break;
	case 23:
		string1 = "Another important attack is the wall kick. When an enemy";
	...
	case 26:
		...
		break;
	case 27:
		string1 = "The enemy can now reverse your attacks.";
		break;
	case 28:
	...
	case 31:
		...
		break;
	case 32:
		string1 = "The enemy can attack in " + std::to_string(int(maxtime - stagetime)) + " seconds.";
		string2 = "This imaginary opponents attacks will be highlighted";
		string3 = "to make this easier.";
		break;
	case 33:
		string1 = "Reverse three enemy attacks!";
		break;
	case 34:
		string1 = "Reverse two more enemy attacks!";
		break;
	case 35:
		string1 = "Reverse one more enemy attack!";
		break;
	case 36:
		string1 = "Excellent!";
		break;
	...
	case 38:
		...
		break;
	case 39:
		string1 = "There is now an imaginary knife";
	...
	case 41:
		...
		break;
	case 42:
		string1 = "The knife is the smallest weapon and the least encumbering.";
		string2 = "You can equip or unequip it while standing, crouching,";
		string3 = "running or flipping.";
		break;
	case 43:
		string1 = "You perform weapon attacks the same way as unarmed attacks,";
		...
		break;
	case 44:
		string1 = "The enemy now has your knife!";
		string2 = "Please reverse two of his knife attacks.";
		break;
	case 45:
		string1 = "Please reverse one more of his knife attacks.";
		break;
	case 46:
		string1 = "Now he has a sword!";
		string2 = "The sword has longer reach than your arms, so you";
		string3 = "must move close to reverse the sword slash.";
		break;
	case 47:
		string1 = "Long weapons like the sword and staff are also useful for defense;";
		...
		break;
	case 48:
		string1 = "The staff is like the sword, but has two main attacks.";
	...
	case 49:
		...
		break;
	case 50:
		string1 = "You now know everything you can learn from training.";
		string2 = "Everything else you must learn from experience!";
		break;
	case 51:
		string1 = "Walk out of the training area to return to the main menu.";
		break;
	}
